...
import com.tramites1cero1.tramiappquibdo.ui.components.PolicyCheckboxRow
...
import com.tramites1cero1.tramiappquibdo.ui.screen.main.ModalFormMode
                ...
                onClick = {
                    if (viewModel.validate()) {
                        if (state.isValidSaveInformation) {
                            ...
                            Toast.makeText(context, "La información no es válida.", Toast.LENGTH_LONG).show()
                        }
                    } else {
